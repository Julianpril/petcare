  ...
  return (
    <View style={styles.inputGroup}>
      ...
      <View style={styles.commonTraitsContainer}>
        {commonTraits.map((trait) => (
          <TouchableOpacity
            ...
            style={[
              styles.commonTrait,
              selectedTraits.includes(trait) && styles.commonTraitSelected,
            ]}
          ...
          >
            ...
            <Text
              style={[
                ...
                selectedTraits.includes(trait) && styles.commonTraitTextSelected,
              ]}
            >
              {trait}
            </Text>
      ...
      <View style={styles.customTraitContainer}>
        ...
        <TouchableOpacity style={styles.addTraitButton} onPress={onAddTrait}>
          <LinearGradient colors={['#6366f1', '#8b5cf6']} style={styles.addTraitGradient}>
      ...
      {selectedTraits.length > 0 && (
        <View style={styles.selectedTraitsContainer}>
          <Text style={styles.subLabel}>Seleccionadas ({selectedTraits.length}):</Text>
