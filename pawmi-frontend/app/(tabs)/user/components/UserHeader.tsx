      ...
      <View style={styles.headerContent}>
        <View style={styles.headerTop}>
          <View style={styles.greetingSection}>
            ...
            <Text style={styles.subtext}>Aqui esta el resumen de tus mascotas</Text>
          </View>
        ...
        <TouchableOpacity style={styles.statsToggle} onPress={onToggleStats} activeOpacity={0.7}>
        ...
        {!statsCollapsed && (
          <View style={styles.statsRow}>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statNumber}>{careCount}</Text>
